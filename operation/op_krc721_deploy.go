...
////////////////////////////////
type OpMethodDeployKRC721 struct {}
...
func init() {
    ...
    Method_Registered[opName] = new(OpMethodDeployKRC721)
}

////////////////////////////////
func (opMethodDeployKRC721 OpMethodDeployKRC721) FeeLeast(daaScore uint64) (uint64) {
    // if daaScore ...
    return 100000000000
}

////////////////////////////////
func (opMethodDeployKRC721 OpMethodDeployKRC721) ScriptCollectEx(index int, script *storage.DataScriptType, txData *storage.DataTransactionType, testnet bool) {}

////////////////////////////////
func (opMethodDeployKRC721 OpMethodDeployKRC721) Validate(script *storage.DataScriptType, daaScore uint64, testnet bool) (bool) {
    if (script.From == "" || script.P != "KRC-721" || !ValidateTick(&script.Tick) || !ValidateAmount(&script.Max) || !ValidateAmount(&script.Lim) || !ValidateDec(&script.Dec, "0")) {
        return false
    }
...
////////////////////////////////
func (opMethodDeployKRC721 OpMethodDeployKRC721) PrepareStateKey(opScript *storage.DataScriptType, stateMap storage.DataStateMapType) {
...
////////////////////////////////
func (opMethodDeployKRC721 OpMethodDeployKRC721) Do(index int, opData *storage.DataOperationType, stateMap storage.DataStateMapType, testnet bool) (error) {
...
////////////////////////////////
/*func (opMethodDeployKRC721 OpMethodDeployKRC721) UnDo() (error) {
    // ...
    return nil
}*/
