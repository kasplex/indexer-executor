...
////////////////////////////////
type OpMethodTransferKRC721 struct {}

////////////////////////////////
func init() {
    opName := "transferKRC721"
    P_Registered["KRC-721"] = true
    Op_Registered[opName] = true
    Method_Registered[opName] = new(OpMethodTransferKRC721)
}

////////////////////////////////
func (opMethodTransferKRC721 OpMethodTransferKRC721) FeeLeast(daaScore uint64) (uint64) {
    return 0
}

////////////////////////////////
func (opMethodTransferKRC721 OpMethodTransferKRC721) ScriptCollectEx(index int, script *storage.DataScriptType, txData *storage.DataTransactionType, testnet bool) {}

////////////////////////////////
func (opMethodTransferKRC721 OpMethodTransferKRC721) Validate(script *storage.DataScriptType, daaScore uint64, testnet bool) (bool) {
    if (script.From == "" || script.To == "" || script.P != "KRC-721" || !ValidateTick(&script.Tick) || !ValidateAmount(&script.Amt)) {
        return false
    }
    script.Max = ""
    script.Lim = ""
...
////////////////////////////////
func (opMethodTransferKRC721 OpMethodTransferKRC721) PrepareStateKey(opScript *storage.DataScriptType, stateMap storage.DataStateMapType) {
...
////////////////////////////////
func (opMethodTransferKRC721 OpMethodTransferKRC721) Do(index int, opData *storage.DataOperationType, stateMap storage.DataStateMapType, testnet bool) (error) {
...
////////////////////////////////
/*func (opMethodTransferKRC721 OpMethodTransferKRC721) UnDo() (error) {
    // ...
    return nil
}*/
