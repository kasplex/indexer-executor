...
type RPC_MessageStreamClient interface {
	Send(*KaspadRequest) error
	Recv() (*KaspadResponse, error)
	grpc.ClientStream
}
...
func (x *rPCMessageStreamClient) Send(m *KaspadRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*KaspadResponse, error) {
	m := new(KaspadResponse)
...
type RPC_MessageStreamServer interface {
	Send(*KaspadResponse) error
	Recv() (*KaspadRequest, error)
	grpc.ServerStream
}
...
func (x *rPCMessageStreamServer) Send(m *KaspadResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*KaspadRequest, error) {
	m := new(KaspadRequest)
